...
:page-aliases: tutorials:userprofile-couchbase-mobile-xamarin:sync/userprofile_sync
...
:githubsrc: https://github.com/couchbaselabs/userprofile-couchbase-mobile-xamarin/tree/sync/modules/userprofile/examples/src
...
+
** link:https://docs.couchbase.com/userprofile-couchbase-mobile/standalone/userprofile/xamarin/userprofile_basic.html[Fundamentals] of using Couchbase Lite 2.0 as a standalone database
** link:https://docs.couchbase.com/userprofile-couchbase-mobile/query/userprofile/xamarin/userprofile_query.html[Query Basics] with a prebuilt version of Couchbase Lite database
...
== System Overview
We will be working with a simple "User Profile" app which we introduced in the link:https://docs.couchbase.com/userprofile-couchbase-mobile/standalone/userprofile/xamarin/userprofile_basic.html[Fundamentals Tutorial] and extended in the link:https://docs.couchbase.com/userprofile-couchbase-mobile/query/userprofile/xamarin/userprofile_query.html[Query Tutorial]. 
...
- Download the  `User Profile Demo` project from link:https://github.com/couchbaselabs/userprofile-couchbase-mobile-xamarin/archive/sync.zip[here]
...
* Launch the Sync Gateway from the command line with the *sync-gateway-config-userprofile-walrus.json* config file. This file is bundled with the User Profile mobile App source that you downloaded as per instructions in <<Fetching App Source Code>> section. The `sync-gateway-config-userprofile-walrus.json` will be located in the `/path/to/UserProfileDemo/modules/userprofile/examples/src` folder 
+
...
* Open the `*sync-gateway-config-userprofile-walrus.json*` file using any text editor of your choice. The `sync-gateway-config-userprofile-walrus.json` is located in the app bundle at `/path/to/UserProfileDemo/modules/userprofile/examples/src`. 
+
...
* Open the link:{githubsrc}/UserProfileDemo.Repositories/DatabaseManager.cs[*DatabaseManager.cs*] file and locate the `Start` method.
+
[source,c#]
----
